...
* [ACTIVATION PROCEDURE](activation-procedure.md) - Step-by-step activation procedure, preconditions, and verification commands for NR Massive MIMO Sleep Mode.
* [DEACTIVATION PROCEDURE](deactivation-procedure.md) - Details the deactivation sequence, traffic impact, and CLI commands for disabling the NR Massive MIMO Sleep Mode feature.

# reference-table

* [PARAMETERS](parameters.md) - Configuration parameters for tuning NR Massive MIMO Sleep Mode on a per-cell basis.
