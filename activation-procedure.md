...
description: Activation procedure for Closed-Loop Power Control High-Band, including
  traffic impact, preconditions, rollout recommendations, and CLI commands.
tags:
- activation
- procedure
- rancli
...
This section outlines the activation procedure for Closed-Loop Power Control High-Band.
