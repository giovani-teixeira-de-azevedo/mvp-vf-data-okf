...
description: Provides an overview of the Cascaded RET Support feature, detailing AISG
  daisy-chaining, transport variants, device discovery, and management capability.
tags:
- RET
- AISG
- ALD
...
This section provides an overview of the Cascaded RET Support feature within the *Cascaded RET Support* documentation, describing its operational context, transport mechanisms, device discovery, and capabilities.
...
## Bus Topology and Device Capacity
