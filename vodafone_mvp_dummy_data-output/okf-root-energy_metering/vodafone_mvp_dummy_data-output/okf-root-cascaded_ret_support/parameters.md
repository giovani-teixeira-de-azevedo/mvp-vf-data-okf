...
title: Parameters
description: Defines the configuration parameters governing AISG bus scanning behavior
  and per-device tilt control for Cascaded RET Support.
tags:
- parameters
- cascaded-ret
- aisg
...
This section details the configuration parameters governing AISG bus scanning behavior and per-device tilt control for Cascaded RET Support.
