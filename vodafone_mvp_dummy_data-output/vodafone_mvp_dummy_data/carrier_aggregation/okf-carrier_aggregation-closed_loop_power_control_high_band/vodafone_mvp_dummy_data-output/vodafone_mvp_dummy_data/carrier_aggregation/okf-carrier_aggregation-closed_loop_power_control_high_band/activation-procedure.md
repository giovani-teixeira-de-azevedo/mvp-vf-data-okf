...
description: Activation procedure, traffic impact, preconditions, CLI commands, and
  verification for Closed-Loop Power Control High-Band.
tags:
- activation
- power-control
- rancli
