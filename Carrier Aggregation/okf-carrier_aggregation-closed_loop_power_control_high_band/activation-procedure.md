...
The Activation Procedure defines the preconditions, recommended rollout order, traffic impact, and step-by-step CLI commands for enabling Closed-Loop Power Control High-Band on a node.
