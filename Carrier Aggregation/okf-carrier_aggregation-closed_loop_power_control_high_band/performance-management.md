...
description: Performance management guidelines, Key Performance Indicators (KPIs),
  and counter definitions for evaluating closed-loop power control.
tags:
